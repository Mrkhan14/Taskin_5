...
export class PostsPage extends Component {
  ...
  render() {
    ...
    const getPage = (page) => {
      ...
      const newActivePage =  page === '+' ? activePage +1 : page === '-' ? activePage - 1 : page
        ...
        <section>
          <div className="container">
            ...
            <div className="post-cart">
             ...
             <button className={`${activePage === 1 ? 'disabled' : ''}`} onClick={() => getPage('-')}>Previous</button>
            {Array(pagesQuantity)
              .fill(1)
              .map((_, i) => (
                <button
               ...
               <button className={`${activePage === pagesQuantity ? 'disabled' : ''}`}  onClick={() => getPage('+')}>Nex</button>
          </div>
        </section>
      </Fragment>
    );
